...
const sheets = [
  ...
  },
  {
    ...
    rows: [
      ...
      ,["PR-016", "P1", "Owner/Admin", "Phantom Threads", "Two item types exist, one with an emoji and one without.", "Create/edit the emoji, then inspect order creation, order detail, Production list/board, and workflow detail.", "Exactly one emoji saves and appears internally; plain text or multiple emoji are rejected; the blank item type shows a neutral garment icon; public tracking does not expose the emoji.", "", "Not Run", "Manual + Automated", "Apply migration 20260809140000 first."]
      ,["PR-017", "P1", "Manager", "Phantom Threads", "Production contains several workflows and garment types.", "Select two garment types and one workflow, then change search, queue, list/board view, and open/close a workflow pane.", "Only matching tenant items appear and every active filter/view parameter is preserved; reset clears filters; foreign/unknown IDs never broaden results.", "", "Not Run", "Manual + Automated", ""]
    ]
  },
  {
