...
export async function getSettingsOverview() {
  ...
  for (const result of [itemTypes, stages, customerStatuses, workgroups, paymentModes, expenseCategories, measurementFields, standardSizes, communicationTemplates, tenantUsers]) {
    if (result.error) {
